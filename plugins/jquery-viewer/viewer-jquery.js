...
function(i) {
	...
	u.prototype = {
		...
		initList: function() {
			...
			function() {
				n.addClass(X);
				s.children().each(function(i,a){
//					console.log(a);
					if(a.className=='mark'){
						n.children().eq(i).addClass('mark');
					}
				})
			})
		},
		...
		mark: function(){
			var outliNode=this.$images.parent("li").eq(this.index);
			var inliNode=this.$items.eq(this.index);
			var page_name = outliNode.attr("ab");
			if(page_name == "change"){
				var temp2 = "0";
				if(outliNode.hasClass('mark')){
					inliNode.removeClass('mark');
					outliNode.removeClass('mark');
				}
				else{
					inliNode.addClass('mark');
					outliNode.addClass('mark');
					temp2 = "1";
				}
				var xmlhttp;
				...
				var id = outliNode.attr("v");
				xmlhttp.open("GET","/diagnosis/updateFile.htm?id="+id+"&temp2="+temp2,true);
				xmlhttp.send();
			}else if(page_name == "noChange"){
				alert("无效操作");
			}else{
				if(outliNode.hasClass('mark')){
					inliNode.removeClass('mark');
...
//			console.log(this.$images.parent('li').eq(this.index),this.$toolbar.children(':last'),this.$items.eq(this.index));
	...
	u.TEMPLATE = '<div class="viewer-container"><div class="viewer-canvas"></div><div class="viewer-footer"><div class="viewer-title"></div><ul class="viewer-toolbar"><li class="viewer-zoom-in" data-action="zoom-in"></li><li class="viewer-zoom-out" data-action="zoom-out"></li><li class="viewer-one-to-one" data-action="one-to-one"></li><li class="viewer-reset" data-action="reset"></li><li class="viewer-prev" data-action="prev"></li><li class="viewer-play" data-action="play"></li><li class="viewer-next" data-action="next"></li><li class="viewer-rotate-left" data-action="rotate-left"></li><li class="viewer-rotate-right" data-action="rotate-right"></li><li class="viewer-flip-horizontal" data-action="flip-horizontal"></li><li class="viewer-flip-vertical" data-action="flip-vertical"></li><li class="viewer-mark" data-action="mark" hidden="hidden"></li></ul><div class="viewer-navbar"><ul class="viewer-list"></ul></div></div><div class="viewer-tooltip"></div><div class="viewer-button" data-action="mix"></div><div class="viewer-player"></div></div>',
	u.other = i.fn.viewer,
